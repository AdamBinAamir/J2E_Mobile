...
const SignUp_Org = ({navigation}) => {
  ...
  return (
    <View>
      ...
      <Text>Website</Text>
      <TextInput onChangeText={(text) => setWebsite(text)} />
      <Text>About</Text>
      <TextInput onChangeText={(text) => setAbout(text)} />
 
      <Button title="SignUp" onPress={handleSignUpOrg} />
      <Text>OR</Text>
      <Button title="Login" onPress={() => navigation.navigate('Login_Org')} />
    </View>
  );
};
